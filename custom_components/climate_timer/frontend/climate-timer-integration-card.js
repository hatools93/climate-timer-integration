 ...
 */function pt(t){return ut({...t,state:!0,attribute:!1})}const gt=240,_t=15;function mt(t){if(!t||"string"!=typeof t)return null;const e=t.trim().toLowerCase();if(!e)return null;const i=e.match(/^(?:(\d+)\s*h)?\s*(?:(\d+)\s*m)?$/);if(!i)return null;const s=i[1]?parseInt(i[1],10):0,r=i[2]?parseInt(i[2],10):0;if(0===s&&0===r&&!i[1]&&!i[2])return null;const n=60*s+r;return n>0?n:null}function ft(t,e,i=240,s=15){return function(t,e=240,i=15){const s=i,r=Math.round(t/i)*i,n=Math.floor(e/i)*i,a=Math.max(s,n);return Math.max(s,Math.min(a,r))}(t+("up"===e?s:-s),i,s)}function vt(t){const e=t.split(":");return 1e3*(3600*(parseInt(e[0],10)||0)+60*(parseInt(e[1],10)||0)+(parseInt(e[2],10)||0))}function yt(t){if(t<60)return`${t}m`;return`${Math.floor(t/60)}h ${t%60}m`}function $t(t){const e=Math.floor(t/1e3),i=Math.floor(e/60),s=e%60;return`${String(i).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function bt(t){return Math.max(0,Date.parse(t)-Date.now())}function wt(t,e){const i=vt(e);if(0===i)return 1;const s=(i-Math.max(0,Date.parse(t)-Date.now()))/i;return Math.max(0,Math.min(1,s))}var At;let xt=At=class extends ot{constructor(){super(...arguments),this.duration=30,this.disabled=!1,this.maxDuration=gt,this.stepSize=_t,this.finishesAt=null,this.durationStr="00:30:00",this.timerActive=!1,this._tick=0,this._intervalId=null,this._isDragging=!1,this._lastAngle=null,this._accumulatedRotation=0,this._touchStartY=null}updated(t){super.updated(t),t.has("timerActive")&&(this.timerActive?this._startInterval():this._stopInterval())}disconnectedCallback(){super.disconnectedCallback(),this._stopInterval()}connectedCallback(){super.connectedCallback(),this.timerActive&&this._startInterval()}_startInterval(){this._stopInterval(),this._intervalId=window.setInterval(()=>{this._tick++},1e3)}_stopInterval(){null!==this._intervalId&&(window.clearInterval(this._intervalId),this._intervalId=null)}render(){return this.timerActive&&this.finishesAt?this._renderCountdown():this._renderSelector()}_renderCountdown(){this._tick;const t=bt(this.finishesAt),e=wt(this.finishesAt,this.durationStr),i=$t(t),s=At.CIRCUMFERENCE,r=s*(1-e);return F`
        ...
        <div class="dial-wrapper active">
          <svg class="dial-svg" viewBox="0 0 180 180">
            ...
            <circle
              ...
              stroke-dasharray="${s}"
              stroke-dashoffset="0"
              transform="rotate(-90 ${At.CENTER} ${At.CENTER})"
            />
    ...
    `}_renderSelector(){const t=this.stepSize,e=(this.duration-t)/(this.maxDuration-t),i=At.CIRCUMFERENCE,s=i*(1-e),r=(360*e-90)*Math.PI/180,n=At.CENTER+At.RADIUS*Math.cos(r),a=At.CENTER+At.RADIUS*Math.sin(r);return F`
  ...
  `,t([ut({type:Number})],Et.prototype,"duration",void 0),t([ut({type:Boolean})],Et.prototype,"disabled",void 0),t([ut({type:Number,attribute:"max-duration"})],Et.prototype,"maxDuration",void 0),t([ut({type:Number,attribute:"step-size"})],Et.prototype,"stepSize",void 0),t([ut({type:String,attribute:"finishes-at"})],Et.prototype,"finishesAt",void 0),t([ut({type:String,attribute:"duration-str"})],Et.prototype,"durationStr",void 0),t([ut({type:Boolean,attribute:"timer-active"})],Et.prototype,"timerActive",void 0),t([pt()],Et.prototype,"_tick",void 0),Et=t([ct("cti-simple-timer-selector")],Et);let St=Ct=class extends ot{constructor(){super(...arguments),this.finishesAt=null,this.durationStr="00:30:00",this.active=!1}render(){if(!this.active||!this.finishesAt)return q;const t=bt(this.finishesAt),e=wt(this.finishesAt,this.durationStr),i=$t(t),s=Ct.CIRCUMFERENCE,r=s*(1-e);return F`
    ...
    `}};St.RADIUS=44,St.CIRCUMFERENCE=2*Math.PI*Ct.RADIUS,St.styles=a`
    :host {
      display: block;
    }
  ...
  `,t([ut({attribute:!1})],kt.prototype,"hass",void 0),t([pt()],kt.prototype,"_config",void 0),t([pt()],kt.prototype,"_selectedDuration",void 0),t([pt()],kt.prototype,"_errorMessage",void 0),kt=t([ct("climate-timer-integration-card")],kt);let Dt=class extends ot{setConfig(t){this._config={...t}}render(){if(!this.hass||!this._config)return F``;const t=(e=this.hass.states,Object.keys(e).filter(t=>t.startsWith("climate.")));var e;const i=this._getEntityError(),s=this._hasManagedTimer();return F`
  ...
  `,t([ut({attribute:!1})],Dt.prototype,"hass",void 0),t([pt()],Dt.prototype,"_config",void 0),Dt=t([ct("climate-timer-integration-card-editor")],Dt),window.customCards=window.customCards||[],window.customCards.push({type:"climate-timer-integration-card",name:"Climate Timer Integration Card",description:"A timer-based climate entity controller that automatically turns off after a set duration.",preview:!1});
